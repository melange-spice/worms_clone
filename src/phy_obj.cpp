...
phy_obj::phy_obj(Vector2 position, Vector2 velocity, float radius, int bounce_before_death)
    : position{position}, velocity{velocity},radius{radius}, bounce_before_death{bounce_before_death}
{
}